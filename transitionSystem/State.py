...
class State:
    ...
    def copy_state(self, next_state):
        ...
        next_state._rel[0:self._next_index] = deepcopy(self._rel[0:self._next_index])
        next_state._head[0:self._next_index] = deepcopy(self._head[0:self._next_index])
        next_state._have_parent[0:self._next_index] = deepcopy(self._have_parent[0:self._next_index])
    ...
    def prepare_atom_feat(self, encoder_output, offset, bucket, vocab):
        ...
        self.hidden_state = torch.cat((hidden_s0, hidden_s1, hidden_s2, hidden_q0), 1)
